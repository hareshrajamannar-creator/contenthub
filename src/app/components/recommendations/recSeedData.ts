...
export const seedRecommendations: Recommendation[] = [
  ...
  // 1 — 69de016e9c10756b6b61329f
  {
    ...
    aeoScore: {
      ...
      competitor: 85,
      subScores: [
        { name: 'Intent Match',          weight: 20, you: 91, competitor: 70, delta: 21 },
        { name: 'Search Visibility',     weight: 25, you: 90, competitor: 80, delta: 10 },
        { name: 'Content Depth',         weight: 20, you: 97, competitor: 84, delta: 13 },
        { name: 'Brand Alignment',       weight: 20, you: 91, competitor: 78, delta: 13 },
        { name: 'Publishing Readiness',  weight: 15, you: 94, competitor: 72, delta: 22 },
      ],
    },
  ...
  // 5 — 69de01cb9c10756b6b6132aa
  {
    ...
    generatedAsset: {
      type: 'blog',
      title: 'Property Appraisal and Rental Management in Dubbo | Raine & Horne',
      previewText: 'Whether you\'re thinking of selling or renting out your Dubbo property, a professional appraisal is the smartest first step — and it costs you nothing.',
      approved: false,
      fullContent: JSON.stringify([
        { body: "Whether you're thinking of selling, leasing, refinancing, or simply planning ahead, a professional property appraisal gives you accurate, local intelligence about what your home or investment property is worth right now. At Raine & Horne Dubbo, we provide free sales and rental appraisals for homeowners and landlords across Dubbo and surrounding communities — backed by decades of local market knowledge and real transactional data." },
        { heading: "Sales Appraisal vs. Rental Appraisal — What's the Difference?", body: "Both appraisals are free and carry no obligation, but they serve different purposes:", listItems: ["A sales appraisal estimates what buyers in the current Dubbo market would pay for your property", "A rental appraisal estimates the weekly rent your property could achieve as a leased investment", "Many owners request both to compare the financial outcomes of selling versus renting before making a decision", "Appraisals are updated regularly — a valuation from 12 months ago may no longer reflect market conditions"], image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&q=80", imageAlt: "Suburban house exterior in Dubbo" },
        { heading: "What We Assess During a Dubbo Property Appraisal", body: "Our local agents consider a comprehensive range of factors when calculating your property's market or rental value:", listItems: ["Land size and block dimensions", "Number of bedrooms, bathrooms, and garages", "Build quality, age, and structural condition", "Kitchen and bathroom finishes and recent renovations", "Street appeal, outdoor entertaining, and landscaping", "Proximity to Dubbo CBD, schools, parks, and transport", "Recent comparable sales or rentals in your suburb"], image: "https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=900&q=80", imageAlt: "Property being assessed in Dubbo" },
        { heading: "Suburbs We Cover", body: "We appraise and manage properties across the entire Dubbo region, including:", listItems: ["Central Dubbo and Dubbo CBD surrounds", "South Dubbo and Glenfield Park", "West Dubbo and Keswick Estate", "East Dubbo and Delroy Park", "North Dubbo and Grangewood", "Brocklehurst, Wongarbon, and Eumungerie", "Surrounding rural and lifestyle properties"], image: "https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=900&q=80", imageAlt: "Aerial view of Dubbo suburb" },
        { heading: "What Our Property Management Service Includes", body: "For landlords who decide to rent rather than sell, Raine & Horne Dubbo provides a complete property management service:", listItems: ["Tenant sourcing, screening, and reference checks", "Lease preparation and lodgement in line with NSW legislation", "Rent collection and monthly disbursements with clear statements", "Routine property inspections and written reports", "Maintenance coordination using trusted local tradespeople", "End-of-tenancy condition reporting and bond management"] },
        { heading: "How Long Does an Appraisal Take?", body: "An in-person appraisal walk-through typically takes 20–40 minutes. Following the inspection, you'll receive a written report within 24–48 hours covering the estimated sale or rental value, comparable market data, and our recommended strategy — whether that's listing, leasing, or making targeted improvements first." },
        { heading: "Book Your Free Dubbo Property Appraisal", body: "Whether you're ready to act now or simply want to understand your options, our team is here to help. Book your free, no-obligation property appraisal with Raine & Horne Dubbo today and get an accurate, locally grounded view of what your property is worth in today's market." }
      ]),
    },
    aeoScore: {
      you: 92,
      competitor: 81,
      subScores: [
        { name: 'Intent Match',          weight: 20, you: 89, competitor: 74, delta: 15 },
        { name: 'Search Visibility',     weight: 25, you: 94, competitor: 76, delta: 18 },
        { name: 'Content Depth',         weight: 20, you: 91, competitor: 82, delta:  9 },
        { name: 'Brand Alignment',       weight: 20, you: 88, competitor: 71, delta: 17 },
        { name: 'Publishing Readiness',  weight: 15, you: 91, competitor: 79, delta: 12 },
      ],
    },
  ...
  // 7 — 69de02549c10756b6b6132b3
  {
    ...
    title: 'Build Dubbo Suburb Pages to Capture Local Property Searches',
    description:
      'Potential buyers and landlords are searching for suburb-specific property information in Dubbo, but your site lacks dedicated pages for these searches. Creating suburb landing pages for South Dubbo, Keswick Estate, Grangewood, and other key areas will capture high-intent local traffic and convert searches into appraisal requests.',
    category: 'Content',
    impactLabel: 'High impact',
    effort: 'Quick win',
    themeId: 'residential-property-sales',
    ...
    generatedAsset: {
      type: 'blog',
      title: 'Dubbo Suburb Property Guide: South Dubbo, Keswick Estate, Grangewood and More',
      previewText: "Buyers and tenants searching for property in Dubbo want suburb-specific information. Here's what you need to know about Dubbo's most sought-after neighbourhoods in 2026.",
      approved: false,
      fullContent: JSON.stringify([
        { body: "Whether you're buying a home, investing in a rental property, or looking for the right suburb to raise a family, Dubbo offers a diverse range of neighbourhoods to suit different budgets and lifestyles. This guide covers the key suburbs in the Dubbo region — what makes each area popular, the types of properties available, and what buyers and renters are prioritising in 2026." },
        { heading: "South Dubbo", body: "South Dubbo is one of the most established and sought-after areas in the region, popular with families and investors alike. The suburb offers a mix of older homes with generous land sizes and more recently renovated properties.", listItems: ["Strong demand from families due to proximity to local schools and parks", "Three and four bedroom homes are the most common property type", "Rental demand is consistently high with low vacancy rates", "Well-suited to investors seeking long-term, stable tenancy outcomes"], image: "https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=900&q=80", imageAlt: "South Dubbo residential street" },
        { heading: "Keswick Estate", body: "Keswick Estate is a newer residential area that has attracted significant interest from first home buyers and young families looking for modern homes on manageable land sizes.", listItems: ["Modern house-and-land packages appeal to first home buyers and owner-occupiers", "Proximity to shopping centres and Dubbo's growing western infrastructure", "Properties here tend to present well and attract quality tenant profiles", "One of the more affordable entry points for investors in the Dubbo market"] },
        { heading: "Grangewood", body: "Grangewood is a well-regarded family suburb offering a quieter residential feel with good access to Dubbo's CBD and amenities. It has become increasingly popular with upsizers and families seeking more space.", listItems: ["Larger block sizes make Grangewood attractive for families wanting outdoor space", "Strong owner-occupier community with stable long-term residents", "Good access to Dubbo Base Hospital and major retail precincts", "Properties tend to hold value well and attract quality buyers when listed"] },
        { heading: "Delroy Park", body: "Delroy Park offers an established suburb environment with a mix of property types suited to investors and owner-occupiers. Its central location within Dubbo makes it a popular choice for tenants who value convenience.", listItems: ["Popular with tenants due to easy access to the Dubbo CBD and employment hubs", "A strong mix of three bedroom homes and smaller investment-grade properties", "Consistent rental demand and manageable entry prices for investors", "Proximity to Dubbo Regional Theatre and cultural precinct adds lifestyle appeal"] },
        { heading: "Get a Free Suburb-Specific Appraisal", body: "If you own a property in any of these Dubbo suburbs and want to know its current market value, our team can provide a free, no-obligation sales or rental appraisal. Contact Raine & Horne Dubbo today and get accurate, locally grounded advice from agents who know these streets." },
        { heading: "Frequently Asked Questions" },
        { heading: "Which Dubbo suburb has the best rental yield?", body: "Rental yields vary by property type and condition, but South Dubbo, Delroy Park, and Keswick Estate consistently deliver strong returns for investors. A free rental appraisal from our team will give you a realistic yield estimate for your specific property." },
        { heading: "Are properties in Dubbo good for investment?", body: "Dubbo offers relatively affordable entry prices, tight rental vacancy, and steady population growth — all factors that make it an attractive regional investment market. As with any property purchase, location, condition, and the right management are key to a strong outcome." },
        { heading: "How do I find out what my Dubbo property is worth?", body: "The most reliable way to determine your property's current value is a free market appraisal from a local agent who has recently sold comparable properties in your suburb. Contact Raine & Horne Dubbo to arrange an obligation-free appraisal at a time that suits you." },
        { heading: "Which Dubbo suburbs are best for first home buyers?", body: "Keswick Estate and Wongarbon are currently among the most accessible entry points for first home buyers, offering modern or established homes at relatively affordable price points. Grangewood and Brocklehurst are also worth considering for buyers seeking value with room to grow." },
      ]),
    },
    aeoScore: {
      you: 88,
      competitor: 79,
      subScores: [
        { name: 'Intent Match',          weight: 20, you: 85, competitor: 77, delta:  8 },
        { name: 'Search Visibility',     weight: 25, you: 90, competitor: 68, delta: 22 },
        { name: 'Content Depth',         weight: 20, you: 93, competitor: 80, delta: 13 },
        { name: 'Brand Alignment',       weight: 20, you: 84, competitor: 75, delta:  9 },
        { name: 'Publishing Readiness',  weight: 15, you: 88, competitor: 70, delta: 18 },
      ],
    },
  ...
  // 8 — 69de02549c10756b6b6132b4
  {
    ...
    aeoScore: {
      ...
      competitor: 83,
      subScores: [
        { name: 'Intent Match',          weight: 20, you: 88, competitor: 79, delta:  9 },
        { name: 'Search Visibility',     weight: 25, you: 93, competitor: 72, delta: 21 },
        { name: 'Content Depth',         weight: 20, you: 95, competitor: 86, delta:  9 },
        { name: 'Brand Alignment',       weight: 20, you: 89, competitor: 76, delta: 13 },
        { name: 'Publishing Readiness',  weight: 15, you: 90, competitor: 78, delta: 12 },
      ],
    },
