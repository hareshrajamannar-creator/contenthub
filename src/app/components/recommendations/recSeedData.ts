...
export const seedRecommendations: Recommendation[] = [
  // 1
  {
    ...
    sources: makeSources(
      [
        { title: 'Local Content Impact Analysis', source: 'gemini', snippet: 'Mixed sentiment data suggests strong local reputation but limited digital content presence' },
        { title: 'Market Search Behavior Study', source: 'perplexity', snippet: 'Buyers and sellers actively search for local market updates and suburb insights before choosing agents' },
      ],
      'https://raineandhorne.com.au/dubbo-market-updates',
    ),
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: [], summary: 'Sentiment is mixed: strong praise exists, but some sources say public data is thin. The site lacks consistent Dubbo-specific updates and guides.' },
    generatedAsset: null,
    aeoScore: {
      you: 95,
      competitor: 85,
    ...
    checklist: makeChecklist('69de016e9c10756b6b61329f', [
      { label: 'Pick a publishing rhythm', description: 'Decide how often you\'ll publish — once a month is a solid start. Block an hour in your calendar for it so it actually happens, rather than becoming a "we should do this" task.', stepType: 'task' },
      { label: 'Write your first Dubbo suburb guide', description: 'Pick one suburb you know well — Glenfield Park, South Dubbo, wherever you sell most. Cover what it\'s like to live there, recent price trends, and who it\'s best for. 400–600 words is plenty.', stepType: 'task', targetPage: 'https://raineandhorne.com.au/dubbo-market-updates' },
      { label: 'Add a free appraisal button to every guide', description: 'At the bottom of each piece of content, link to your appraisal request form. Readers who are interested enough to finish an article are exactly the people you want to capture.', stepType: 'task' },
      { label: 'Share it where your clients are', description: 'Post each guide to your Facebook page and email it to your contact list. You don\'t need a big production — copy the first paragraph, add the link, and hit send.', stepType: 'task' },
    ]),
  },
  ...
  // 2
  {
    ...
    youScore: 11.0,
    compScore: 83.3,
    expectedImpact: 'A centralized proof hub will significantly increase enquiry-to-appointment conversion rates by reducing hesitation and building immediate trust. Prospects will see real Dubbo success stories, making them more confident to reach out.',
    keyInsights: [
    ...
    sources: makeSources([{ title: 'Client Satisfaction Analysis', source: 'Multiple sources', snippet: 'Perfect 5.0 rating from 457 reviews indicates exceptional service delivery' }], 'https://raineandhorne.com.au/reviews-dubbo'),
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: [], summary: 'Sentiment shows delighted clients, yet two sources report limited publicly visible reviews.' },
    generatedAsset: null,
    checklist: makeChecklist('69de016e9c10756b6b6132a0', [
      { label: 'Ask 5 recent clients for a quick quote', description: 'Reach out to clients you\'ve helped in the last 6 months. A short message — "Would you mind if I shared your feedback on our website?" — is all it takes. Most happy clients say yes.', stepType: 'task' },
      { label: 'Write a short story for each client', description: 'One paragraph per client: what they needed to do, what made their situation tricky, and what the result was. Specific details (suburb, timeframe, price achieved) make it believable and persuasive.', stepType: 'task' },
      { label: 'Pull in your third-party reviews', description: 'Your Google and RateMyAgent reviews already exist — you just need to surface them. Add a widget or embed a direct link so visitors can see them without leaving your site.', stepType: 'link', links: [{ label: 'Your Google Business reviews', url: 'https://www.google.com/search?q=Raine+%26+Horne+Dubbo+reviews' }, { label: 'RateMyAgent profile', url: 'https://www.ratemyagent.com.au' }] },
      { label: 'Create a dedicated testimonials page', description: 'Put everything in one place — client quotes, case studies, and review links. This page becomes the answer when a prospect asks "why should I choose you?"', stepType: 'task', targetPage: 'https://raineandhorne.com.au/reviews-dubbo' },
    ]),
  },
  ...
  // 3
  {
    ...
    youScore: 16.7,
    compScore: 50,
    expectedImpact: 'Significantly increased landlord enquiries and appraisal requests by removing friction points and building trust through transparency. Clear service standards and easy contact options will convert hesitant visitors into qualified leads.',
    keyInsights: [
    ...
    targetPages: ['https://raineandhorne.com.au/property-management-dubbo', 'https://raineandhorne.com.au/landlords-dubbo'],
    whyItWorks: [
    ...
    sources: makeSources([
      { title: 'Property Management Page Optimization', source: 'perplexity', snippet: 'Clear processes and response times are critical for converting landlord enquiries' },
      { title: 'Landlord Conversion Best Practices', source: 'gemini', snippet: 'Transparency in fees and services increases trust and conversion rates' },
      { title: 'PM Service Page Elements', source: 'perplexity', snippet: 'Above-the-fold CTAs and social proof drive higher enquiry rates' },
    ], 'https://raineandhorne.com.au/property-management-dubbo'),
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: [], summary: 'Overall sentiment is strong, but mentions of administration issues in property management suggest clarity gaps.' },
    generatedAsset: null,
    checklist: makeChecklist('69de016e9c10756b6b6132a1', [
      { label: 'Write out your property management process in plain steps', description: 'Landlords want to know exactly what happens after they sign up. Write it out simply — "We do X within 24 hours, then Y, then Z." Even 5 bullet points is enough to build confidence.', stepType: 'task', targetPage: 'https://raineandhorne.com.au/property-management-dubbo' },
      { label: 'Be upfront about your fees', description: 'A page that clearly lists what\'s included, what costs extra, and what your response guarantees are will outperform vague "contact us for pricing" every time. Transparency wins landlord trust.', stepType: 'task' },
      { label: 'Add a rental appraisal form above the fold', description: 'The most important thing a landlord should see first on your PM page is a way to get a free rental appraisal. Put the form — or a prominent button to it — before they have to scroll.', stepType: 'task' },
      { label: 'Add a few landlord testimonials', description: 'Even 2–3 quotes from happy landlords on this page make a big difference. Ask a couple of long-term clients if you can use their words. Specific details (e.g. "they found me a tenant within a week") work best.', stepType: 'task' },
    ]),
  },
  ...
  // 4
  {
    ...
    youScore: 0,
    compScore: 75,
    expectedImpact: 'Increased visibility in local search results and directory listings will drive more direct phone calls and appraisal inquiries. Consistent business information across platforms strengthens Google\'s confidence in your location data.',
    keyInsights: [
    ...
    sources: makeSources([
      { title: 'LocalSearch business directory', source: 'localsearch.com.au', snippet: 'Local directory where complete profiles can highlight services like free appraisals.' },
      { title: 'Australian Property Institute member directory', source: 'api.org.au', snippet: 'Professional directory; complete profiles build credibility for property appraisal services.' },
    ], 'https://raineandhorne.com.au'),
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: [], summary: 'People search for free property appraisals and home value in Dubbo. Your site lacks consistent, matching listings that highlight "Obligation-free property appraisal" for Dubbo.' },
    generatedAsset: null,
    checklist: makeChecklist('69de01cb9c10756b6b6132a9', [
      { label: 'Claim your profiles on these two directories', description: 'Both LocalSearch and the API member directory are trusted sources that Google uses to verify your business. Competitors already have profiles here — claiming yours takes about 10 minutes each.', stepType: 'link', links: [{ label: 'LocalSearch.com.au — claim your free listing', url: 'https://www.localsearch.com.au/claim-listing' }, { label: 'API.org.au — member directory listing', url: 'https://www.api.org.au/find-a-member' }] },
      { label: 'Use this exact business info on both profiles', description: 'Small inconsistencies — like "Rd" vs "Road" or a different phone number — confuse Google and reduce how much it trusts your location data. Copy these details exactly as shown.', stepType: 'nap', napData: { name: 'Raine & Horne Dubbo', address: '63 Macquarie Street, Dubbo NSW 2830', phone: '(02) 6882 6999' } },
      { label: 'Add these search phrases to your profile', description: 'Paste these into the Services or Description field on each profile. These are the exact words Dubbo property owners type when looking for an appraisal — being in the profile text helps you show up.', stepType: 'keyword', keywords: ['Free property appraisal Dubbo', 'Rental appraisal Dubbo NSW', 'Obligation-free property appraisal', 'Home valuation Dubbo'] },
      { label: 'Upload a few photos', description: 'Profiles with photos get significantly more clicks than those without. Use 3–5 real images — your office exterior, your team, or a recent property you\'ve listed. Phone photos are fine.', stepType: 'task' },
      { label: 'Write a short business description', description: 'In 2–3 sentences, mention that you offer free appraisals, how quickly you respond, and that you\'ve been in Dubbo for 40+ years. Keep the tone conversational — write it like you\'d explain it to a neighbour.', stepType: 'task' },
    ]),
  },
  ...
  // 5
  {
    ...
    youScore: 0,
    compScore: 75,
    expectedImpact: 'This dedicated appraisal page will become your primary lead generation tool for property valuations. It will rank prominently in local searches, get cited by AI assistants, and provide a clear conversion path for homeowners. Expect steady growth in qualified appraisal requests within 1-2 months of launch.',
    keyInsights: [
    ...
    sources: makeSources([
      { title: 'Property Appraisal – Ray White Dubbo', source: 'raywhitedubbo.com.au', snippet: 'Dedicated Dubbo appraisal page with clear benefits and lead form.' },
      { title: 'Home Valuation – Matt Hansen Real Estate', source: 'matthansenrealestate.com.au', snippet: 'Free market appraisal page tailored to local sellers.' },
      { title: 'About Us – Elders Real Estate Dubbo', source: 'dubbo.eldersrealestate.com.au', snippet: 'Promotes free, no-obligation appraisals for Dubbo homeowners.' },
    ], 'https://raineandhorne.com.au'),
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: [], summary: 'People search for "free property appraisal Dubbo", "home value Dubbo", and rental appraisal help. Competitors capture these leads with dedicated pages.' },
    generatedAsset: null,
    aeoScore: {
      you: 92,
      competitor: 81,
    ...
    checklist: makeChecklist('69de01cb9c10756b6b6132aa', [
      { label: 'Create a page just for Dubbo property appraisals', description: 'Right now there\'s no single place people land when they search "free property appraisal Dubbo." This page fixes that. It should have a clear headline, a short explanation of what you offer, and a form.', stepType: 'task', targetPage: 'https://raineandhorne.com.au/free-property-appraisal-dubbo' },
      { label: 'Add an appraisal request form', description: 'Keep it short: name, phone, property address, and whether it\'s residential or rental. The simpler the form, the more people complete it. Avoid asking for things you don\'t actually need upfront.', stepType: 'task' },
      { label: 'List the suburbs you cover and your turnaround time', description: 'Prospects want to know if you\'ll come to their area and how fast. A simple sentence — "We cover all Dubbo suburbs and surrounding areas, with appraisals typically completed within 24–48 hours" — answers both.', stepType: 'task' },
      { label: 'Add a short FAQ section', description: 'Answer the questions you get asked most: Is it free? Do I have to sell? How long does it take? What do you look at? A 4–5 question FAQ removes the hesitation that stops people from submitting.', stepType: 'task' },
    ]),
  },
  ...
  // 6
  {
    ...
    youScore: 12,
    compScore: 55,
    expectedImpact: 'Transform more website visitors into qualified seller leads by removing friction from the inquiry process. A streamlined form with callback guarantee builds trust and urgency, while mobile-optimized contact options capture prospects at their moment of highest intent.',
    keyInsights: [
    ...
    sources: makeSources([
      { title: 'Property Appraisal – Ray White Dubbo', source: 'raywhitedubbo.com.au', snippet: 'Uses a direct, simple form to request local appraisals.' },
      { title: 'Ray White Dubbo agency profile – Domain', source: 'domain.com.au', snippet: 'Prompts users to request a free appraisal from agents.' },
    ], 'https://raineandhorne.com.au'),
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: [], summary: 'People searching in Dubbo want quick ways to request a free appraisal. Your site needs a short, mobile-friendly form with a 1-hour callback promise.' },
    generatedAsset: null,
    checklist: makeChecklist('69de01cb9c10756b6b6132ab', [
      { label: 'Add a short appraisal form to the top of your page', description: 'The form should be visible without scrolling. Ask for name, phone, and property address only — that\'s all you need to call them back. More fields = fewer submissions.', stepType: 'task', targetPage: 'https://raineandhorne.com.au' },
      { label: 'Add a "we call you back within 1 hour" message', description: 'Put this directly next to your submit button. Ray White Dubbo does this and it\'s one of the main reasons they get cited for fast-response appraisals. A specific promise is far more convincing than "we\'ll be in touch."', stepType: 'task' },
      { label: 'Add a sticky call button for people on mobile', description: 'Most property searches happen on phones. A button that stays at the bottom of the screen as people scroll — showing your number and a "Call now" label — makes it effortless to reach you.', stepType: 'task' },
      { label: 'Make sure someone actually calls back within the hour', description: 'The promise only works if you keep it. Set up an internal alert (email, SMS, or your CRM) so whoever is on duty gets notified the moment a form is submitted.', stepType: 'task' },
    ]),
  },
  ...
  // 7
  {
    ...
    youScore: 5.6,
    compScore: 83.3,
    expectedImpact: 'Immediate increase in local search visibility across Dubbo suburbs, capturing property owners actively searching for agents. Each suburb page becomes a lead generation tool, showcasing your local expertise and converting searches into listing appointments.',
    keyInsights: [
    ...
    targetPages: ['https://raineandhorne.com.au/dubbo', 'https://raineandhorne.com.au/dubbo/sales', 'https://raineandhorne.com.au/dubbo/property-management'],
    whyItWorks: [
    ...
    sources: makeSources([
      { title: 'Local Search Optimization', source: 'chatGPT', snippet: 'Suburb-specific pages are essential for local real estate visibility' },
      { title: 'Content Strategy Analysis', source: 'gemini', snippet: 'Missing local content creates gaps in search presence' },
      { title: 'SWOT Analysis', source: 'SWOT', snippet: 'Digital expansion identified as key opportunity' },
    ], 'https://raineandhorne.com.au/dubbo'),
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: [], summary: 'Prospects with changing expectations look online for clear, local service information. No Dubbo suburb-specific pages exist.' },
    generatedAsset: null,
    aeoScore: {
      you: 88,
      competitor: 79,
    ...
    checklist: makeChecklist('69de02549c10756b6b6132b3', [
      { label: 'List the suburbs you want to target first', description: 'Start with the 3–5 suburbs where you do most of your business — Glenfield Park, South Dubbo, Dubbo CBD, and surrounds. You can add more later. Trying to do all of them at once is how this task never gets done.', stepType: 'task' },
      { label: 'Write a page for each suburb', description: 'Each page needs: what you do there (sales, rentals, or both), a sentence about why you know the area, and a contact or appraisal form. 300 words minimum. Keep the language simple — write it like you\'re talking to a homeowner, not an SEO tool.', stepType: 'task', targetPage: 'https://raineandhorne.com.au/dubbo' },
      { label: 'Include a recent result or local detail on each page', description: 'One line like "We recently sold a home in [suburb] in 18 days at $X" tells more than a paragraph of generic copy. If you can\'t use a specific sale, mention something local — a school, landmark, or suburb character.', stepType: 'task' },
      { label: 'Link to these pages from your homepage and directory profiles', description: 'New pages won\'t be found unless something points to them. Add a "Areas we serve" section to your homepage, and include links in your LocalSearch and Google Business profiles.', stepType: 'task' },
    ]),
  },
  ...
  // 8 (was 9)
  {
    ...
    targetPages: ['https://raineandhorne.com.au/dubbo/property-management-support', 'https://raineandhorne.com.au/dubbo/communication-standards'],
    whyItWorks: [
    ...
    sources: makeSources([
      { title: 'SWOT Analysis - Administrative Weaknesses', source: 'SWOT', snippet: 'Occasional complaints about administration in property management' },
      { title: 'Market Threat Assessment', source: 'SWOT', snippet: 'Changing Consumer Expectations' },
      { title: 'Customer Satisfaction Data', source: 'gemini', snippet: 'Perfect 5.0 rating indicating strong satisfaction' },
    ], 'https://raineandhorne.com.au/dubbo/property-management-support'),
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: [], summary: 'Before landlords enquire, they want simple, clear communication standards they can trust. The site lacks a page with response times, update frequency, and escalation steps.' },
    generatedAsset: null,
    checklist: makeChecklist('69de02549c10756b6b6132b5', [
      { label: 'Document your actual response times', description: 'Write down what you genuinely commit to: urgent issues (4 hours), routine enquiries (24 hours), maintenance requests (48 hours). If the standard isn\'t set internally first, publishing it externally won\'t stick.', stepType: 'task' },
      { label: 'Create a simple service standards page', description: 'One page that lists your communication commitments, how often landlords get updates, and what happens when something needs escalating. Plain language, no jargon — think of it as your promise in writing.', stepType: 'task', targetPage: 'https://raineandhorne.com.au/dubbo/property-management-support' },
      { label: 'Add direct contact info for different request types', description: 'Make it clear who to call for urgent repairs vs routine enquiries vs after-hours emergencies. A simple table or three labelled contact options removes the friction of "I don\'t know who to call."', stepType: 'task' },
      { label: 'Add a FAQ for common admin concerns', description: 'Answer the questions that precede hesitation: "What happens if I can\'t reach you?", "How quickly will a repair be handled?", "When do I get my monthly statement?" — these are the objections that stop landlords from signing up.', stepType: 'task' },
      { label: 'Put an enquiry form on every PM page', description: 'Once a landlord has read your standards and feels confident, the form should be right there — no hunting for a contact page. Add a phone number too, prominently displayed.', stepType: 'task' },
    ]),
  },
  ...
  // 9
  {
    ...
    youScore: 0,
    compScore: 66.7,
    expectedImpact: 'By establishing a strong presence on these dominant property portals, you\'ll capture more leads from rural property seekers who rely on these platforms.',
    keyInsights: [
    ...
    sources: makeSources([
      { title: 'Domain Australia', source: 'domain.com.au', snippet: 'Major Australian property portal used by buyers and sellers.' },
      { title: 'realestate.com.au', source: 'realestate.com.au', snippet: 'Leading property portal where agencies list and promote properties.' },
      { title: 'Farmbuy', source: 'farmbuy.com', snippet: 'Specialist portal for farms and rural properties in Australia.' },
    ], 'https://raineandhorne.com.au'),
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: [], summary: 'People searching on Google for rural property sales in Dubbo often start on big property portals. Your site likely lacks fully completed, rural-focused profiles on these portals.' },
    generatedAsset: null,
    checklist: makeChecklist('69de03209c10756b6b6132bd', [
      { label: 'Claim or verify your agency profiles on all three portals', description: 'Domain, Realestate.com.au, and Farmbuy are the portals rural buyers and sellers use most. Claiming takes 10–15 minutes each.', stepType: 'link', links: [{ label: 'Domain.com.au — claim your agency profile', url: 'https://www.domain.com.au/agent-admin' }, { label: 'Realestate.com.au — agency portal login', url: 'https://www.realestate.com.au/agent-admin' }, { label: 'Farmbuy.com — list your agency', url: 'https://www.farmbuy.com' }] },
      { label: 'Use consistent business details across all three', description: 'Your business name, address, and phone number must be identical on every platform.', stepType: 'nap', napData: { name: 'Raine & Horne Dubbo', address: '63 Macquarie Street, Dubbo NSW 2830', phone: '(02) 6882 6999' } },
      { label: 'Write a rural-focused service description', description: 'Add a bio that specifically mentions farms, lifestyle blocks, and acreage — not just residential sales.', stepType: 'task' },
      { label: 'Upload team photos and link to your website', description: 'Profiles with photos and a website link get significantly more clicks.', stepType: 'task' },
      { label: 'Add current rural listings and note recent sales', description: 'An empty profile signals inactivity. Populate with any current rural or lifestyle listings you have.', stepType: 'task' },
    ]),
  },
  ...
  // 10
  {
    ...
    youScore: 40.0,
    compScore: 44.4,
    expectedImpact: 'Transform your hidden success into visible proof that drives enquiries. When prospects see specific Dubbo properties you\'ve sold, prices achieved, and happy client testimonials, they\'ll choose you over competitors who only make claims without evidence.',
    keyInsights: [
    ...
    targetPages: ['https://raineandhorne.com.au/dubbo/case-studies', 'https://raineandhorne.com.au/dubbo/testimonials'],
    whyItWorks: [
    ...
    competitors: makeCompetitors([
      ...
      },
      {
        ...
        llmSnippet: 'Ray White Dubbo publishes outcome-focused case studies with specific Dubbo properties, achieved prices, and direct vendor quotes.',
        totalCitations: 29,
        citationRank: 2,
        citedBy: ['ChatGPT', 'Perplexity'],
      },
    ...
    sources: makeSources([
      { title: 'Market Analysis', source: 'chatGPT', snippet: 'Reports excellent satisfaction but lacks public visibility' },
      { title: 'Competitive Research', source: 'perplexity', snippet: 'Insufficient publicly available data despite strong performance' },
      { title: 'Business Strengths', source: 'SWOT', snippet: 'High client satisfaction and successful outcomes identified' },
    ], 'https://raineandhorne.com.au/dubbo/case-studies'),
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: [], summary: 'One source reports excellent satisfaction, but other sources say there isn\'t enough public data.' },
    generatedAsset: null,
    aeoScore: {
      you: 91,
      competitor: 83,
    ...
    checklist: makeChecklist('69de02549c10756b6b6132b4', [
      { label: 'Reach out to 5 recent clients for their story', description: 'You don\'t need 10 — five good stories are more powerful than ten thin ones.', stepType: 'task' },
      { label: 'Write each story in three sentences', description: 'Keep it tight: (1) what the client wanted to do, (2) what made it complicated, (3) what the result was.', stepType: 'task' },
      { label: 'Create a case studies page', description: 'One page that holds all your stories. Think of it as your portfolio.', stepType: 'task', targetPage: 'https://raineandhorne.com.au/dubbo/case-studies' },
      { label: 'Put a quote or two on your homepage', description: 'A short client quote near the top of your homepage converts more visitors into enquiries.', stepType: 'task' },
    ]),
  },

  // 11 — NEW FAQ recommendation
  {
    id: 'faq-rec-001',
    title: 'Add FAQ schema for "property appraisal Dubbo"',
    description: 'AI models cite FAQ pages 3x more often than regular content for question-based queries. A structured FAQ page covering common appraisal questions will increase citation share.',
    category: 'FAQ',
    impactLabel: '↗ +12% citation share',
    effort: 'Quick win',
    locations: 5,
    themeId: 'content',
    ...
    completedAt: null,
    whyItWorks: [
      'FAQ schema is one of the highest-weighted AEO signals',
      'Question-based queries have 40% higher citation rates',
      'Competitors without FAQ schema score 22 points lower on average',
    ],
    competitors: [],
    sources: [],
    contentGaps: [],
    promptsTriggeringThis: [],
    llmCoverageGap: { platforms: ['ChatGPT', 'Gemini'], summary: 'Neither platform cites your site for property appraisal FAQs' },
    generatedAsset: {
      type: 'faq',
      title: 'Property Appraisal FAQs — Dubbo',
      previewText: 'What is the cost of a property appraisal in Dubbo? How long does an appraisal take?...',
      fullContent: '',
      approved: false,
    },
    checklist: [],
